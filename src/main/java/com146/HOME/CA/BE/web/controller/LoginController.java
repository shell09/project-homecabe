...
public class LoginController {
  ...
  public String findTelPW(
          ...
          Model model){
    Login telPWs = loginSVC.searchTelPW(findTelPW.getId(),findTelPW.getTel());
    model.addAttribute("telPWs",telPWs);
  ...
  public String findEmailPW(
          ...
          HttpServletRequest httpServletRequest,
          Model model){
    Login emailPWs = loginSVC.searchEmailPW(findEmailPW.getId(),findEmailPW.getEmail());
    model.addAttribute("emailPWs",emailPWs);
